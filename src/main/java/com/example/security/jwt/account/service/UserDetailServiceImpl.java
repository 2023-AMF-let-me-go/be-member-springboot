...
public class UserDetailServiceImpl implements UserDetailsService {
    protected final Logger logger = LoggerFactory.getLogger(UserDetailsService.class);
    ...
    public UserDetails loadUserByUsername(final String username) {
        ...
        if(!account.getMemberStatus().equals("CONFIRMED")) {
            logger.info("승인되어 있지 않습니다.");
            throw new RuntimeException(account.getUsername() + " -> 승인되어 있지 않습니다.");
        }
