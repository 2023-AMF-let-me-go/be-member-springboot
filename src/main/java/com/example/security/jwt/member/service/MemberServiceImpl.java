...
public class MemberServiceImpl implements MemberService {
    ...
    public ResponseMember.Info signup(RequestMember.Register registerDto) {
        ...
        if(registerDto.memberType().equals("I")) {
            authority = Authority.builder()
                    .authorityName("ROLE_INDIVIDUAL")
                    .build();
        } else if (registerDto.memberType().equals("C")) {
            authority = Authority.builder()
                    .authorityName("ROLE_CORP")
                    .build();
        }
        ...
        Account user = Account.builder()
                ...
                .memberStatus(registerDto.memberType().equals("I") ? "CONFIRMED" : "WAITING")
                .memberType(registerDto.memberType())
                .businessNo(registerDto.businessNo())
